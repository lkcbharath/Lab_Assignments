...
**           the column index
**           Example of the first matrix with size 3:
**
**                0,0,0
**                1,1,1
**                2,2,2
**
**           Multiplication is then fairly simple, where the result matrix
**           element R(i,j) is the sum of products of kth element in ith
