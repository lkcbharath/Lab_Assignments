...
def main():
	...
	print("Maximum value:",r.maximum(r));
	print("Minimum value:",r.minimum(r));

	print("Predecessor of 8:",r.successor(r.search(r,8)))

	print("Successor of 8:",r.predecessor(r.search(r,8)))
